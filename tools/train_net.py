...
def train(cfg):
    ...
    # Get adaptive threshold parameters
    adaptive_threshold = loss_cfg.get('adaptive_threshold', True)
    adaptive_threshold_min = loss_cfg.get('adaptive_threshold_min', 0.01)
    adaptive_threshold_epochs = loss_cfg.get('adaptive_threshold_epochs', 0.2)
    ...
    loss_fn = BboxLoss(
        ...
        adaptive_threshold_epochs=adaptive_threshold_epochs
    )
